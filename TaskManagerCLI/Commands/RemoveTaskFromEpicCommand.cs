...
{
    public class RemoveTaskFromEpicCommand : IExecutable
    {
        ...
        public CommandExecutionResult Run(string[] args)
        {
            ...
            try
            {
                TaskManagerAPI.TaskManager.GetInstance().RemoveTaskFromEpic(project, task as IAssignable, epicTask as EpicTask);
            }
